        ...
        <div class="row">
            <div class="card">
                <div class="card-header border-bottom custom-header-color">
                    <h4 class="card-title">Form Input Data Kerusakan Barang</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Barang -->
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="damage-type" class="form-control" name="damage-type" placeholder="Jenis Kerusakan" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="damage-detail" class="form-control" name="damage-detail" placeholder="Detail Kerusakan" />
                                </div>
                            </div>
                        </div>
...
@section('javascript')
    <script>
        ...
        function resetAll(){
            $(':input').val('');
            $("select#barang").prop('selectedIndex', 0);
            $("select#user-servicer").prop('selectedIndex', 0);
        }
    </script>
@endsection
