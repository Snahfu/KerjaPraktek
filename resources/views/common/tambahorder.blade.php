                    ...
                    <form class="form form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-1 row">
                                    <div class="">
                                        <label class="col-form-label" for="event-name">Harga barang per item adalah (Dalam Rupiah)</label>
                            ...
                            <div class="col-12">
                                <div class="mb-1 row">
                                    <div class="">
                                        <label class="col-form-label" for="event-name">Subtotal barang item diatas adalah (Dalam Rupiah)</label>
                                        <input type="text" class="form-control-sm" id="event-name"name="event-name"
                                            placeholder="Nama Acara" />
                                    </div>
                                </div>
