                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="datetime-local" id="tgl-input" class="form-control" name="tgl-input"
                                        value="{{ $shipping->tglInput }}" disabled />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    @foreach ($event as $e)
                                        @if ($shipping->events_id == $e->id)
                                            <input type="datetime-local" readonly id="tgl-event" class="form-control" name="tgl-event"
                                                value="{{ $e->tanggal }}" />
                                        @endif
                                    @endforeach
                                </div>
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    @foreach ($event as $e)
                                        @if ($shipping->events_id == $e->id)
                                            <input type="text" readonly id="venueEvent" value="{{ $e->lokasi }}"
                                                class="form-control" />
                                        @endif
                                    @endforeach
                                </div>
...
@section('javascript')
    <script>
        ...
        function updateBarang() {
            ...
            document.getElementById('tgl-event').value = "";
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == "failed") {
                        ...
                        document.getElementById('tgl-event').value = tanggalEvent;
                        ...
                        tanggalKirimDateTime = year + "-" + month + "-" + date + "T" + hour + ":" + minute +
                            ":" + second;
                        ...
                        if (jenis === "Kirim") {
                            ...
                            if (Object.keys(response.datas).length === 0) {
                                ...
                                //     option.value = response.datas[data].qty + '~~' + response.datas[data]
                                //         .idjenis + '~~' + response.datas[data].jenis + '~~' + response.datas[
                                //             data].type_barang,
        ...
        function updateTabel() {
            ...
            for (var i = 0; i < arraySpesifikasiJson.length; i++) {
                if (arraySpesifikasiJson[i].length > 0) {
                    console.log(arraySpesifikasiJson);
                    stringHTML +=
                        `<tr><td colspan="2">${jenis_map[i]}</td><td colspan="1">Quantity: ${arraySpesifikasiJson[i][0].quantity}</td></tr>`
